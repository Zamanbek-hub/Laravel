...
<head>
	...
	<link rel="stylesheet" type="text/css" href="/css/resume_pdf.css" media="all" />
	<link href="{{ public_path('/css/resume_pdf.css') }}" rel="stylesheet" type="text/css" />
	<link href="{{ public_path('/css/resume_pdf_main.css') }}" rel="stylesheet" type="text/css" />
	<link href="/css/resume_pdf_main.css'" rel="stylesheet" type="text/css" />
	<link href="/css/resume_pdf.css'" rel="stylesheet" type="text/css" />
			...
			<div class="yui-gc">
				...
				<div class="yui-u">
					<div class="contact-info">
						...
						<h3><a href="mailto:name@yourdomain.com">{{$resume->email}}</a></h3>
						<h3>7-708-050-52-67</h3>
					</div><!--// .contact-info -->
				</div>
			</div><!--// .yui-gc -->
		</div><!--// hd -->
