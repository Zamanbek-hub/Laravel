          ...
          <div class="container mt-5">
              <div class="row " >
                      <div class="col-md-3">
                          <div class="list-group mb-5">  
                              <a href="#" class="list-group-item list-group-item-action disabled d-flex" >
                                      <span class="material-icons" style="margin-right:5px; ">face</span> Alibi Toktassyn
                              </a>
                    ...
                    <div class="col-md-6">
                      <div class="card mb-4" >
                          <div class="card-body">
                                <h5 class="card-title" style="font-weight: bold;">Resume № 1</h5>
                                <p class="card-subtitle mb-2 text-muted" >Last ch in anges3.10.2019</p>
                                <p class="card-text" style="font-weight: bolder;">Android Developer, developer</p>
                      ...
                      <div class="card mb-4" >
                          <div class="card-body">
                                <h5 class="card-title"  style="font-weight: bold;">Resume № 2</h5>
                                <h6 class="card-subtitle mb-2 text-muted">Last changes in 27.05.2020</h6>
                                <p class="card-text"  style="font-weight: bolder;"> Junior System Analyst</p>
                                <a href="#" class="btn btn-outline-warning " type="button" style="color: black; border-color: grey; ">More details</a>
                                <a href="#" class="btn btn-outline-warning" type="button" style="color: black; border-color: grey;  margin: 8px;">Edit</a>
                          </div>
                      </div>
                        <div class="card mb-4" >
                          <div class="card-body">
                                <h5 class="card-title"  style="font-weight: bold;">Resume № 3</h5>
                                <h6 class="card-subtitle mb-2 text-muted">Last changes in  27.05.2020</h6>
                                <p class="card-text"  style="font-weight: bolder;"> Junior Data scientist</p>
                                <a href="#" class="btn btn-outline-warning " type="button" style="color: black; border-color: grey; ">More details</a>
                                <a href="#" class="btn btn-outline-warning" type="button" style="color: black; border-color: grey;  margin: 8px;">Edit</a>
                          </div>
                      </div>
