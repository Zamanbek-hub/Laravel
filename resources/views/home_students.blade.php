                ...
                <div class="col-md-3">
                    @foreach($vacancies as $vacancy)
                        <div class="tile wide quote">
                            <div class="header">
                                <div class="left">
                                <div class="count">{{$vacancy->employer->company_name}}</div>
                                <div class="title"><a href="/vacancy/{{$vacancy->id}}" >Open Vacancy</a></div>
                                </div>

                            </div>
                            <div class="body">
                                <div class="title">{{$vacancy->description}}</div>
                                <div class="title">{{$vacancy->salary}}</div>
                            </div>
                        </div>
                    @endforeach
                </div>
